  ...
  <div class="block">
    ...
    <el-date-picker
      ...
      <el-form-item label="岗位" prop="jobId">
        <el-select v-model="ruleForm.jobId" placeholder="请选择活动区域">
          <!-- <el-option
          ...
          <el-option v-for="entry in jobs" :label="entry.jobName" :value="entry.jId" :key="entry.jId"></el-option>
        </el-select>
      </el-form-item>
      <!-- 入职日期 -->
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        folk: [{ required: true, message: "请选择民族", trigger: "blur" }],
        nativePlace: [
        ...
        house: [{ required: true, message: "请填写户口地", trigger: "blur" }],
        degree: [{ required: true, message: "请选择学历", trigger: "blur" }],
        diploma: [{ required: true, message: "请选择学位", trigger: "blur" }],
        school: [
          { required: true, message: "请填写毕业学校", trigger: "blur" }
        ],
        spical: [{ required: true, message: "请填写专业", trigger: "blur" }],
        graduateDate: [
