  ...
  <div>
    <div style="margin-top: 15px;">
      <el-row>
        ...
        <el-col :span="22">
          <el-input placeholder="请输入部门名称" v-model="search.deptName" class="input-with-select">
    ...
    <el-table :data="tableData.list" border style="width: 100%">
      <el-table-column prop="dId" label="编号" width="150"></el-table-column>
      ...
      <el-table-column prop="deptPhone" label="电话" width="120"></el-table-column>
      <el-table-column prop="fax" label="传真" width="120"></el-table-column>
      <el-table-column prop="parentId" label="上级部门" width="120"></el-table-column>
      <el-table-column prop="createDate" label="创建日期" width="120"></el-table-column>
      <el-table-column prop="active" label="是否有效" width="120" :formatter="activeformat"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    del(row) {
      this.delete("dept/del", row.dId, row.active);
    },
    deltext(active) {
